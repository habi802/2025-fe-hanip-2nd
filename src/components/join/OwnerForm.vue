...
const emit = defineEmits(["update:form", "update:owner", "update:errors"]);
...
const validateBusinessNumber = () => {
    const regex = /^[0-9]{10}$/;
    if (!regex.test(owner.businessNumber)) {
...
<template>
    <div class="owner-form">
        ...
        <div class="sevLine"></div>
            ...
            <input type="text" :value="form.name" @input="e => updateField('name', e.target.value)"
                @focus="() => clearError('name')" />
        </div>
        <div class="sevLine"></div>
        ...
        <div class="form-group address-group">
            ...
            <div class="address-box">
                ...
                <!-- 2줄: 기본주소 -->
                <input type="text" :value="form.address" placeholder="기본주소" readonly class="full-width" />

                <!-- 3줄: 상세주소 -->
                <input type="text" :value="form.addressDetail" placeholder="상세주소"
        ...
        <div class="form-group">
            ...
            <div class="phone-input">
                <select :value="form.ownerTel1" @change="e => updateField('ownerTel1', e.target.value)">
                    <option>02</option>
                    <option>031</option>
                    <option>032</option>
                    <option>033</option>
                ...
                <input type="text" v-model="ownerTel3" maxlength="4" @input="onOwnerTelInput($event, 'ownerTel3')"
                    :class="{ invalid: errors.ownerTel3 }" @keydown="onlyNumberInput" />
            </div>
        ...
        <div class="form-group">
            ...
            <div class="phone-input">
                <select :value="form.ownerPhone1" @change="e => updateField('phone1', e.target.value)">
                    <option>010</option>
                    <option>016</option>
                    <option>017</option>
                    <option>018</option>
                ...
                <input type="text" maxlength="4" :value="form.phone2"
                    @input="e => updateField('ownerPhone2', e.target.value)" :class="{ invalid: errors.phone2 }" />
                <input type="text" maxlength="4" :value="form.phone3"
                    @input="e => updateField('ownerPhone3', e.target.value)" :class="{ invalid: errors.phone3 }" />
            </div>
...
.form-group {
    ...
    .error-msg {
        color: #ff6666;
        font-size: 15px;
        margin-left: 240px; // sortation 너비와 맞춤
        margin-top: 5px;
    }
}
