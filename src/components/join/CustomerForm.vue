        ...
        <div class="form-group address-group">
            ...
            <div class="address-box">
                ...
                <div class="address-row">
                    <input type="text" :value="localForm.postcode" placeholder="우편번호" readonly />
                    <button @click="handleAddressSearch" type="button">주소검색</button>
                </div>

                <!-- 2줄: 기본주소 -->
                <input type="text" :value="localForm.address" placeholder="기본주소" readonly class="full-width" />

                <!-- 3줄: 상세주소 -->
                <input type="text" :value="localForm.addressDetail" placeholder="상세주소"
