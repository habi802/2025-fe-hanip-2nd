...
// 상세 조회 중인 주문의 id를 바로 ids에 추가하여 숨기기 상태 변경
                ...
                <b-row>
                    <b-col cols="12" lg="6">
                        <b-row>
                            ...
                            <b-col cols="12">
                                <DateTable title="order" :items="state.orders" :field="fields" id-key="orderId" @row-selected="goToBoardSection" @row-checked="addCheckItemIds" />
                            </b-col>
                    ...
                    <b-col ref="boardSection" cols="12" lg="6">
                        <BoardCard title="order" :item="order" id-key="orderId" @set-item-status="addSelectedItemId" />
                    </b-col>
                </b-row>
            </b-col>
        </b-row>
