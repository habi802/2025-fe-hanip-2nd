...
<template>
  ...
  <div :class="$style.groupParent1">
    ...
    <img
      :class="$style.materialSymbolsarrowForwardIcon1"
      src="material-symbols:arrow-forward-ios-rounded.svg"
    />
    ...
    <img
      :class="$style.materialSymbolsarrowForwardIcon2"
      src="material-symbols:arrow-forward-ios-rounded.svg"
    />
    ...
    <img
      :class="$style.materialSymbolsarrowForwardIcon3"
      src="material-symbols:arrow-forward-ios-rounded.svg"
    />
  ...
  <div v-else>
    <img
      :class="$style.materialSymbolsarrowForwardIcon"
      src="material-symbols:arrow-forward-ios-rounded.png"
    />
